...
{
    $msg = insertPost($_POST['category'],$_POST['topic'],$_POST['subtopic'],$_POST['status'],$_POST['content'], $_POST['csrf_token']);
}
?>
<!DOCTYPE html>
<html>
                                ...
                                <form action="<?= $_SERVER['PHP_SELF'] ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-12 col-md-12">
                                            <select class="form-control" id="cat-select-input" name="category" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-12 col-md-12"><input type="text" class="form-control" id="topic-input" placeholder="Topic" name="topic" required></div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col"><label for="subtopic-input" class=" form-control-label">Sub Topic: <span class="text-danger">(Optional)</span></label></div>
                                        <div class="col-12 col-md-12"><input type="text" class="form-control" id="subtopic-input" placeholder="Sub Topic" name="subtopic"></div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col">
                                            <label for="status" class="form-control-label">Publish Status:</label></div>
                                            <div class="col-12 col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-12 col-md-12">
                                                <textarea  id="content" name="content" class="form-control ckeditor" required autocomplete="off"></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <br><br>
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary" name="add-post"><i class="fa fa-check"></i> Add Post</button>
